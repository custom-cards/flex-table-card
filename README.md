...
[![interface-stable-release-0.6](https://img.shields.io/badge/stable-release_0.6-green.svg?style=plastic)](#) 
...
| multi             | list-of-2-strings | matches as the three above, but allows to select multiple different matches being concated using `multi_delimiter` see [#19](https://github.com/custom-cards/flex-table-card/issues/19) for an example on how to write yaml for this.
